...
def add_HelloServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.example.grpcserver.hello.HelloService', rpc_method_handlers)
...
class HelloService(object):
    ...
    def hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.example.grpcserver.hello.HelloService/hello',
